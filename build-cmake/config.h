...
/* Define to 1 if you have module dune-foo available */
#define HAVE_DUNE_FOO 1
...
/* Define to 1 if you have module dune-corepy available */
#define HAVE_DUNE_COREPY 0
...
/* begin private */
/* Name of package */
#define PACKAGE "dune-foo"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "nageswararao.160324@gmail.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "dune-foo"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "dune-foo 1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "dune-foo"
...
#define DUNE_FOO_VERSION "1.0"

/* Define to the major version of dune-foo */
#define DUNE_FOO_VERSION_MAJOR 1

/* Define to the minor version of dune-foo */
#define DUNE_FOO_VERSION_MINOR 0

/* Define to the revision of dune-foo */
#define DUNE_FOO_VERSION_REVISION 0
